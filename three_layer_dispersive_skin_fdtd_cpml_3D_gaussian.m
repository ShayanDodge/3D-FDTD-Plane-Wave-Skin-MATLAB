...
%% capture_and_display_sampled_fields
    if mod(number,50)==0||number==totalTimeStep
Hx_sample=Hx;
Hy_sample=Hy;
Hz_sample=Hz;
Ex_sample=Ex;
...
title({'Ex'}); 
drawnow
% savefig(Hh_1,'three_layer_dispersive_skin_fdtd_cpml_gaussian_3D_3D.fig')
...
grid on
% savefig(Hh_2,'three_layer_dispersive_skin_fdtd_cpml_gaussian_3D_2D.fig')
end
disp(number)
end